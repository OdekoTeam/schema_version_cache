...
class Avro::IO::DatumReader
  ...
  # source://avro//lib/avro/io.rb#499
...
# source://avro//lib/avro/schema.rb#633
module Avro::Name
  class << self
    # source://avro//lib/avro/schema.rb#643
    def add_name(names, new_schema); end

    # source://avro//lib/avro/schema.rb#634
    def extract_namespace(name, namespace); end

    # source://avro//lib/avro/schema.rb#657
...
class Avro::Schema
  ...
  # source://avro//lib/avro/schema.rb#210
  def ==(other, _seen = T.unsafe(nil)); end

  # source://avro//lib/avro/schema.rb#202
  def be_read?(other_schema); end

  # source://avro//lib/avro/schema.rb#171
  def crc_64_avro_fingerprint; end

  # source://avro//lib/avro/schema.rb#214
  def hash(_seen = T.unsafe(nil)); end

  # source://avro//lib/avro/schema.rb#160
  def initFPTable; end

  # source://avro//lib/avro/schema.rb#133
  def logical_type; end

  # source://avro//lib/avro/schema.rb#144
  def md5_fingerprint; end

  # source://avro//lib/avro/schema.rb#206
  def mutual_read?(other_schema); end

  # source://avro//lib/avro/schema.rb#198
  def read?(writers_schema); end

  # source://avro//lib/avro/schema.rb#150
  def sha256_fingerprint; end

  # source://avro//lib/avro/schema.rb#185
  def single_object_encoding_header; end

  # source://avro//lib/avro/schema.rb#188
  def single_object_schema_fingerprint; end

  # source://avro//lib/avro/schema.rb#218
  def subparse(json_obj, names = T.unsafe(nil), namespace = T.unsafe(nil)); end

  # source://avro//lib/avro/schema.rb#232
  def to_avro(_names = T.unsafe(nil)); end

  # source://avro//lib/avro/schema.rb#238
  def to_s; end

  # source://avro//lib/avro/schema.rb#137
  def type; end

  # source://avro//lib/avro/schema.rb#139
  ...
  # source://avro//lib/avro/schema.rb#242
...
class Avro::Schema::EnumSchema < ::Avro::Schema::NamedSchema
  ...
  # source://avro//lib/avro/schema.rb#454
  def to_avro(_names = T.unsafe(nil)); end
end

# source://avro//lib/avro/schema.rb#426
...
class Avro::Schema::Field < ::Avro::Schema
  # source://avro//lib/avro/schema.rb#568
  ...
  # source://avro//lib/avro/schema.rb#592
  def alias_names; end

  # source://avro//lib/avro/schema.rb#566
  def aliases; end

  # source://avro//lib/avro/schema.rb#566
  def default; end

  # source://avro//lib/avro/schema.rb#580
  def default?; end
  ...
  # source://avro//lib/avro/schema.rb#584
  def to_avro(names = T.unsafe(nil)); end
...
class Avro::Schema::FixedSchema < ::Avro::Schema::NamedSchema
  ...
  # source://avro//lib/avro/schema.rb#554
  def match_schema?(schema); end
  ...
  # source://avro//lib/avro/schema.rb#544
  def to_avro(names = T.unsafe(nil)); end
end
...
class Avro::Schema::MapSchema < ::Avro::Schema
  # source://avro//lib/avro/schema.rb#388
  def initialize(values, names = T.unsafe(nil), default_namespace = T.unsafe(nil)); end

  # source://avro//lib/avro/schema.rb#393
  def to_avro(names = T.unsafe(nil)); end

  # source://avro//lib/avro/schema.rb#386
  def values; end
end
...
class Avro::Schema::NamedSchema < ::Avro::Schema
  # source://avro//lib/avro/schema.rb#255
  ...
  # source://avro//lib/avro/schema.rb#253
  def aliases; end

  # source://avro//lib/avro/schema.rb#277
  def fullname; end

  # source://avro//lib/avro/schema.rb#281
  def fullname_aliases; end

  # source://avro//lib/avro/schema.rb#289
  def match_fullname?(name); end

  # source://avro//lib/avro/schema.rb#293
  def match_schema?(schema); end
  ...
  # source://avro//lib/avro/schema.rb#264
  def to_avro(names = T.unsafe(nil)); end
end
...
class Avro::Schema::PrimitiveSchema < ::Avro::Schema
  # source://avro//lib/avro/schema.rb#466
  def initialize(type, logical_type = T.unsafe(nil)); end

  # source://avro//lib/avro/schema.rb#481
  def match_schema?(schema); end

  # source://avro//lib/avro/schema.rb#476
  def to_avro(names = T.unsafe(nil)); end
end

# source://avro//lib/avro/schema.rb#298
class Avro::Schema::RecordSchema < ::Avro::Schema::NamedSchema
  # source://avro//lib/avro/schema.rb#330
  ...
  # source://avro//lib/avro/schema.rb#299
  def doc; end

  # source://avro//lib/avro/schema.rb#299
  def fields; end

  # source://avro//lib/avro/schema.rb#350
  def fields_by_alias; end

  # source://avro//lib/avro/schema.rb#346
  def fields_hash; end

  # source://avro//lib/avro/schema.rb#360
  def to_avro(names = T.unsafe(nil)); end

  class << self
    # source://avro//lib/avro/schema.rb#301
...
class Avro::Schema::UnionSchema < ::Avro::Schema
  # source://avro//lib/avro/schema.rb#401
  def initialize(schemas, names = T.unsafe(nil), default_namespace = T.unsafe(nil)); end

  # source://avro//lib/avro/schema.rb#399
  def schemas; end

  # source://avro//lib/avro/schema.rb#420
  def to_avro(names = T.unsafe(nil)); end
end
...
# source://avro//lib/avro/schema.rb#620
...
class Avro::UnknownSchemaError < ::Avro::SchemaParseError
  # source://avro//lib/avro/schema.rb#626
  def initialize(type, default_namespace); end

  # source://avro//lib/avro/schema.rb#624
  def default_namespace; end

  # source://avro//lib/avro/schema.rb#623
  def type_name; end
end
